...
--Новые посты
(true, default, NULL, 2, "2020-02-01 00:09:01", "NEW post By User1", "user1 bla bla bla", 0),
(true, default, NULL, 3, "2020-02-01", "NEW post By User2", "user2 bla bla bla", 0),
(false, default, NULL, 4, "2020-02-01", "NEW post By User3", "user3 bla bla bla", 0),
--Подтвержденные модератором посты
(true, "ACCEPTED", 1, 2, "2020-02-01 00:00:00", "ACCEPTED post By User1", "user1 bla bla bla", 0),
(true, "ACCEPTED", 1, 3, "2020-02-02 01:00:00", "ACCEPTED post By User2", "user2 bla bla bla", 0),
...
(true, "DECLINED", 1, 3, "2020-02-03", "DECLINED post By User2", "user2 bla bla bla", 0),
